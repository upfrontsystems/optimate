...
def main(global_config, **settings):
    ...
    config.add_route('budgetitem_overheads', '/budgetitem/{id}/overheads/', factory=makeProtectedFunction('projects'))
    config.add_route('overheadview', '/overhead/{id}/', factory=makeProtectedFunction('projects'))
