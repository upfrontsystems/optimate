...
def main(global_config, **settings):
    ...
    config.add_route('node_expand_budgetgroup', 'node/{id}/expand_budgetgroup/{bg_id}')
    config.add_route('node_collapse_budgetgroup', 'node/{id}/collapse_budgetgroup/{bg_id}')
